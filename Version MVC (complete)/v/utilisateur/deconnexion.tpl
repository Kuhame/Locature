...
<body>
    <div class="d-flex flex-column justify-content-center align-items-center vw-100 vh-100 text-center">
        <h1 class="display-6 pb-3">Déconnexion réussite, redirection vers la page d'accueil ...</h1>
